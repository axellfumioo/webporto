...
export default function Hero() {
    const cards = [
        {
            image: '/IMG1_1736.JPG', // Ganti dengan path gambar yang sesuai
            title: 'WanderWorld',
            category: 'Branding'
        },
        {
    ...
    return (
        <div className='z-40 mt-14 mb-4'>
            ...
            <div className="grid gap-4 md:grid-cols-3 mt-4">
                ...
                <div className="bg-[#1F1F1F] p-4 rounded-lg flex items-center space-x-4">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRnhoVwuJmtF1Lu4t9WcsZ7fESV9KdIQ7pVHw&s" className="w-10 h-10" alt="Laravel" />
                    <div>
                ...
                <div className="bg-[#1F1F1F] p-4 rounded-lg flex items-center space-x-4">
                    <img src="https://tailwindcss.com/_next/static/media/tailwindcss-mark.d52e9897.svg" className="w-10 h-10" alt="TailwindCSS" />
                    <div>
